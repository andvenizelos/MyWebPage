...
Now we will go ahead to import our data set using the fread command.
...
__pivot_longer()__ makes dataset **longer** by increasing the number of rows and decreasing the number of columns, whereas __pivot_wider()__ is often utilized to tidy long data sets and often required for the purpose of the analysis (for examples creating a heatmap)
