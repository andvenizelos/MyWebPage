...
Now we will go ahead to import our dataset. There are many ways to import a dataset depending on the file type and the size of the file. Here I am going to show you two ways of importing a dataset with the latter one to be preferred for larger datasets.

::: {#method-1 .section .level3}
### Method 1
